 ...
 */
        ...
        {   
            ...
            //if(i==this.unitNo-1)    this.selectedUnit = UnitFactory.createUnit(8);  //unit cuoi la camp
                                this.selectedUnit = UnitFactory.createUnit(i);
            //tao tuong
            ...
            this.myTeam.push(this.selectedUnit);
        }
        this.client_connect_to_server();
    ...
    game_player.prototype.endGame = function(){
        this.socket.send('e');
    ...
    game_player.prototype.client_connect_to_server = function() {
        ...
        this.socket.on('onserverupdate', this.client_onserverupdate_recieved);
    ...
    }; //game_player.client_connect_to_server

    game_player.prototype.client_onnetmessage = function(data) {
    ...
    switch(command) {
        case 's': //server message
            ...
            switch(subcommand) {
                ...
                case 'jd' : //someone join your game 
                    this.client_onjoindone(commanddata); break;

                case 'ot' : //other team info 
                    this.client_otherteaminfo(commanddata); break;

                case 'eu' : //enemy unit info 
                    this.client_enemyunitinfo(commanddata); break;

                case 'et' : //end turn receive 
                    this.client_endTurnReceive(commanddata); break;
    ...
    game_player.prototype.endTurnSend = function(){
        var dataTeam ='';
        for(var i in this.myTeam)
        {
            for(var iStep =0; iStep<=STEPMAX; iStep++)
            {
                dataTeam += this.myTeam[i].movePathX[iStep]+',' ;    
                dataTeam += this.myTeam[i].movePathY[iStep]+',' ;
                dataTeam += this.myTeam[i].rotateRequest[iStep]+',' ;
                dataTeam += this.myTeam[i].rotateX[iStep]+',' ;
                dataTeam += this.myTeam[i].rotateY[iStep]+',' ;
            }
            dataTeam += this.myTeam[i].attackRequest +',' ;
            dataTeam += this.myTeam[i].attackText +',' ;
            dataTeam += this.myTeam[i].attackIndex +',' ;
            
        }

        this.socket.send('et.'+ dataTeam);
    };  

    game_player.prototype.client_endTurnReceive = function(data){
        ...
        for(var i in this.myTeam)
        {
            for(var iStep =0; iStep<=STEPMAX; iStep++)
            {
                this.enemyTeam[i].movePathX[iStep]=parseInt(move[moveCount]);    
                moveCount++;
                this.enemyTeam[i].movePathY[iStep]=parseInt(move[moveCount]);
                moveCount++;
                this.enemyTeam[i].rotateRequest[iStep]=parseInt(move[moveCount]);
                moveCount++;
                this.enemyTeam[i].rotateX[iStep]=parseInt(move[moveCount]);
                moveCount++;
                this.enemyTeam[i].rotateY[iStep]=parseInt(move[moveCount]);
                moveCount++;
            }
            this.enemyTeam[i].attackRequest=parseInt(move[moveCount]);
                moveCount++;
            this.enemyTeam[i].attackText= move[moveCount];
                moveCount++;
            this.enemyTeam[i].attackIndex= parseInt(move[moveCount]);
                moveCount++;
    ...
    game_player.prototype.hostGame = function(){
        var dataTeam ='';
        for(var i in this.myTeam)
            dataTeam += this.myTeam[i].officer.Number+',' ;

        this.socket.send('h.'+ dataTeam);
        this.host=1;

    };  

    game_player.prototype.joinGame = function(){
        var dataTeam ='';
        for(var i in this.myTeam)
            dataTeam += this.myTeam[i].officer.Number+',' ;
        
        this.socket.send('j.'+ dataTeam);
        this.host=0;
    };  

    game_player.prototype.client_enemyunitinfo = function(data) {
        var officerNumber = data.split(',');

        for(var i =0; i<officerNumber.length-1; i++)
        {
            this.selectedUnit = UnitFactory.createUnit(i);
            this.selectedUnit.officer = OfficerFactory.createOfficer(officerNumber[i]);
        //    this.selectedUnit.officer.Name = officername[i];   //new, data o day la other team infor
        //       this.enemyTeam[i].officer.Name=officername[i];
            this.enemyTeam.push(this.selectedUnit);
            
        }

    }; //client_enemyunitinfo

    game_player.prototype.client_otherteaminfo = function(data) {

       
        this.enemyid = data;   //new, data o day la other team infor
    

    }; //client_otherteaminfo

    game_player.prototype.client_onconnected = function(data) {
...
game_core.prototype.client_onreadygame = function(data) {
  ...
  //  this.players.other.team[0].officer.Name=this.players.other.id;
    this.players.self.state = 'YOU (P'+this.players.self.id+')' + this.players.self.state+this.players.self.team[0].officer.Name+this.players.self.team[1].officer.Name+this.players.self.team[2].officer.Name+this.players.self.team[3].officer.Name+this.players.self.team[4].officer.Name;
    this.players.other.state = '(P'+this.players.other.id+')' + this.players.other.state+this.players.other.team[0].officer.Name+this.players.other.team[1].officer.Name+this.players.other.team[2].officer.Name+this.players.other.team[3].officer.Name+this.players.other.team[4].officer.Name;
...
game_core.prototype.client_onjoingame = function(data) {
    ...
    this.players.other.id = data;   //new, data o day la host userid
...
game_core.prototype.client_onjoindone = function(data) {
...
}; //client_onjoindone  client_otherteaminfo

game_core.prototype.client_otherteaminfo = function(data) {

       
    this.players.other.team[0].officer.Name = data;   //new, data o day la other team infor
...
game_core.prototype.client_draw_info = function() {
    ...
    //    this.ctx.fillText('net_offset : local offset of others players and their server updates. Players are net_offset "in the past" so we can smoothly draw them interpolated.', 10 , 30);
        this.ctx.fillText('player id : '+this.players.self.unitNo, 10 , 50);
        this.ctx.fillText('Unit 1: '+this.players.self.team[0].officer.Name+', '+this.players.self.team[0].typeName, 10 , 70);
        this.ctx.fillText('Unit 2: '+this.players.self.team[1].officer.Name+', '+this.players.self.team[1].typeName, 10 , 90);
        this.ctx.fillText('Unit 3: '+this.players.self.team[2].officer.Name+', '+this.players.self.team[2].typeName, 10 , 110);
        this.ctx.fillText('Unit 4: '+this.players.self.team[3].officer.Name+', '+this.players.self.team[3].typeName, 10 , 130);
        this.ctx.fillText('Unit 5: '+this.players.self.team[4].officer.Name+', '+this.players.self.team[4].typeName, 10 , 150);
        this.ctx.fillText('Unit 6: '+this.players.self.team[5].officer.Name+', '+this.players.self.team[5].typeName, 10 , 170);
        
        this.ctx.fillText('Unit 1: '+this.players.other.team[0].officer.Name+', '+this.players.other.team[0].typeName, 400 , 70);
        this.ctx.fillText('Unit 2: '+this.players.other.team[1].officer.Name+', '+this.players.other.team[1].typeName, 400 , 90);
        this.ctx.fillText('Unit 3: '+this.players.other.team[2].officer.Name+', '+this.players.other.team[2].typeName, 400 , 110);
        this.ctx.fillText('Unit 4: '+this.players.other.team[3].officer.Name+', '+this.players.other.team[3].typeName, 400 , 130);
        this.ctx.fillText('Unit 5: '+this.players.other.team[4].officer.Name+', '+this.players.other.team[4].typeName, 400 , 150);
        this.ctx.fillText('Unit 6: '+this.players.other.team[5].officer.Name+', '+this.players.other.team[5].typeName, 400 , 170);
